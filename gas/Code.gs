...
// 【重要】2026-05-01 以降の運用では Cloudflare Worker API (cloudflare-worker-api/src/line.js) がメイン申込処理を担当。
// このファイルはレガシーコード。LINE リッチメニュー定義の画像/URL/サイズ変更は禁止。
// リッチメニュー URL 引継ぎ・セッション互換性保持のため保持。新規機能は Worker API で実装。
// =====================================================
